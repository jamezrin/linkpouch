...
public interface PersistenceMapper {
    ...
    @Mapping(
            target = "description",
            source = "description",
            qualifiedByName = "stringToLinkDescription")
    ...
    @Mapping(
            target = "screenshotKey",
            source = "screenshotKey",
            qualifiedByName = "stringToScreenshotKey")
    ...
    @Mapping(
            target = "screenshotKey",
            source = "screenshotKey",
            qualifiedByName = "screenshotKeyToString")
    @Mapping(target = "screenshotGeneratedAt", source = "screenshotGeneratedAt")
    @Mapping(target = "createdAt", source = "createdAt")
    @Mapping(target = "updatedAt", source = "updatedAt")
    @Mapping(target = "position", source = "position")
